                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route('venta.store') }}">
                        ...
                        <div class="form-group">
                            <label for="cod_factura">Código de la Factura</label>
...
<script>
    $(document).ready(function() {
        ...
        $('#agregar-producto').click(function() {
            ...
            const nuevaFila = `
                <tr id="fila-${contador}">
                    ...
                    <td>
                        <input type="number" name="detalles[${contador}][iva]" class="form-control iva" value="{{ $iva->valor }}" readonly>
                    </td>
                    <td>
                        <input type="number" name="detalles[${contador}][subtotal]" class="form-control subtotal" readonly>
                    </td>
                    <td>
                        <input type="number" name="detalles[${contador}][total_linea]" class="form-control total-linea" readonly>
                    </td>
                    <td>
        ...
        // Evento para actualizar subtotal, total línea y total general
