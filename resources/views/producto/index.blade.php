                                    ...
                                    @if ($productos->count())
                                        @foreach ($productos as $producto)
                                            <tr>
                                                ...
                                                <td>
                                                    <textarea name="descripcion" class="form-control input-sm" placeholder="Descripción del producto" readonly="true">{{ $producto->descripcion }}</textarea>
                                                </td>
                                                ...
                                                <td>
                                                    @if ($producto->repuestos->isNotEmpty())
                                                        {{ $producto->repuestos->pluck('nombre')->join(', ') }}
                                                    @else
